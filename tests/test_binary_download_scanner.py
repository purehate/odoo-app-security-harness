...
def test_dict_union_static_unpack_public_attachment_datas_response(tmp_path: Path) -> None:
    """Dict-union **route options should preserve public binary response severity."""
    controllers = tmp_path / "module" / "controllers"
    controllers.mkdir(parents=True)
    (controllers / "download.py").write_text(
        """
...
def test_updated_static_unpack_public_attachment_datas_response(tmp_path: Path) -> None:
    """Updated **route options should preserve public binary response severity."""
    controllers = tmp_path / "module" / "controllers"
    controllers.mkdir(parents=True)
    (controllers / "download.py").write_text(
        """

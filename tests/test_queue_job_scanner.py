...
def test_flags_queue_job_tls_verification_disabled_static_kwargs(tmp_path: Path) -> None:
    """Static **kwargs dictionaries should not hide queue job TLS verification disabling."""
    module = tmp_path / "module" / "models"
    module.mkdir(parents=True)
    (module / "jobs.py").write_text(
        """

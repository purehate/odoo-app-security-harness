...
- Seeds hunters with `inventory/cwe-map.json` (559 Odoo bug-shape → CWE/CAPEC/OWASP mappings).
...
- `inventory/cwe-map.json` — 559 Odoo bug-shape → CWE/CAPEC/OWASP mappings (seeds hunters)
